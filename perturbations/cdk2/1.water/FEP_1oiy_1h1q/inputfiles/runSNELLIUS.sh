...
qdyn=/home/shen/code/Q2/src/q6/bin/q6/qdynp
...
timeout 3m /home/shen/code/Q2/src/q6/bin/q6/qfep < qfep.inp > qfep.out || [ $? -eq 124 ]
done
#CLEANUP
rm -r *dcd *inp
#Cleaned dcd inp files
